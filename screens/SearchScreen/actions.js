...
export const loadSearchHistoryItems = search_history_items =>
  action( LOAD_SEARCH_HISTORY_ITEMS, { search_history_items } )

export const loadSearchScreen = () => action( LOAD_SEARCH_SCREEN )
